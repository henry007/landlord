...
import com.hurray.landlord.game.local.LandLordPlayer;
import com.hurray.landlord.game.local.LocalRoom;
...
public class FakeOnlineServer implements GameServer {
    ...
    public FakeOnlineServer() {
        ...
        mRoom = new LocalRoom(players, true);
        mRoom.setFakeOnlineServer(true);
