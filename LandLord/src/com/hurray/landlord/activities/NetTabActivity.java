...
abstract public class NetTabActivity extends TabActivity implements
    ...
    private MessageServiceConnection mConnection;
    ...
    private MessageListener mListener = new MessageListener() {
        ...
        public void onReceive(MessageList msgList) {
            LogUtil.d(TAG, NetTabActivity.this.toString() + " onReceive " + msgList);
    ...
    public void doSend(BaseMessage msg) {
        synchronized (mSendQueue) {
            mSendQueue.add(msg);
            LogUtil.d(TAG, NetTabActivity.this.toString() + " doSend msg: " + msg.toJSONString());
        }
    ...
    private boolean onPreReceived(BaseMessage response) {
        ...
        if (response instanceof PasswordLoginResp) {
    ...
    private void doBindService() {
        ...
        LogUtil.d(TAG, NetTabActivity.this.toString()
