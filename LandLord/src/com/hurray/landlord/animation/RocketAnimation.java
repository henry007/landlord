...
public class RocketAnimation extends ImageTweenFrameAnim {

    private WeakReference<ImageView> mStillViewRef;

    public RocketAnimation(Context context, View tweenView, ImageView frameView,
            ImageView stillView) {
        super(context, frameView, tweenView, R.anim.rocket_tween);
